...
You'll use the GraphQL endpoint which is provided by the platform (https://learn.zone01oujda.ma/api/graphql-engine/v1/graphql). You'll be able to query your own data to populate your profile page.
...
You'll need a JWT to access the GraphQL API. A JWT can be obtained from the signin endpoint (https://learn.zone01oujda.ma/api/auth/signin).
